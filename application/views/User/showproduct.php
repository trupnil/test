...
<form method="POST" action="<?php echo base_url() ?>Home/add_to_cart">
	...
	<input type="hidden" name="id" value="<?php echo $value->pro_id ?>"   >
		<input type="hidden" name="name" value="<?php echo $value->pro_name ?>">
			<input type="hidden" name="price" value="<?php echo $value->pro_price ?>">
			<input type="hidden" name="image" value="<?php echo $value->pro_image ?>">
        <div class="col-md-3 col-sm-6">
            <div class="product-grid9">
                <div class="product-image9">
                    <a href="#">
                        <img class="pic-1" src="<?php echo base_url() ?>uploads/<?php echo $value->pro_image ?>">
                        <img class="pic-2" src="<?php echo base_url() ?>uploads/<?php echo $value->pro_image ?>">
                    </a>
                    <a href="#" class="fa fa-search product-full-view"></a>
                </div>
                <div class="product-content">
                   <h3 class="title"><a href="#"><?php echo $value->pro_name;?></a></h3>
                    <div class="price"> <?php echo $value->pro_price;?></div>
